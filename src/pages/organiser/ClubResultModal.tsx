                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
                            ...
                            <div><strong>DOB:</strong> {resultData?.registration?.dob || '-'}</div>
                            <div><strong>Category:</strong> {resultData?.registration?.skateCategory || '-'}</div>
                    ...
                    <div className="bg-yellow-50 p-4 rounded-lg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
                            ...
                            <div><strong>Event Date:</strong> {resultData?.registration?.event?.eventDate?.split('T')[0] || '-'}</div>
