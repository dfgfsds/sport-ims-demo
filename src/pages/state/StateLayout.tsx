...
const StateLayout: React.FC = () => {
  ...
  const menuItems = [
    ...
    { icon: Users, label: 'Clubs', path: '/state/club' },
    { icon: Calendar, label: 'Events', path: '/state/events' },
    // { icon: Trophy, label: 'Past Events Report', path: '/state/reports' },
    { icon: Building2, label: 'State Profile', path: '/state/profile' }
  ];
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-white transform ${
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-700">
          <div>
            <h1 className="text-lg font-bold text-blue-400">State Portal</h1>
